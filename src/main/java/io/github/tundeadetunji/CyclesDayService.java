...
import io.github.tundeadetunji.cycles.model.DayToken;
import io.github.tundeadetunji.cycles.model.domain.DayPeriod;
...
public class CyclesDayService {
    private static CyclesDayService instance;

    public static CyclesDayService getInstance() {
        if (instance == null) instance = new CyclesDayService();
        return instance;
    }

    private CyclesDayService() {
    ...
    private DayPeriod getCurrentPeriod() {
        int slot = 0;
